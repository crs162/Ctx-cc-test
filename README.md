...
- Network connectivity to `api.cloud.com` and `trust.citrixworkspacesapi.net`
...
- If still failing: Check network connectivity to `api.cloud.com` and `trust.citrixworkspacesapi.net`, verify firewall rules
